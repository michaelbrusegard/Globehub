...
import { AuthorPopoverSkeleton } from '@/components/destination/AuthorPopoverSkeleton';
  ...
  return (
    <article className='mt-12'>
      <section>
        ...
        <AuthorPopoverSkeleton className='hidden md:mb-12 md:inline-flex' />
        <div className='mb-4'>
        ...
        <div className='mx-auto max-w-2xl'>
          <AuthorPopoverSkeleton className='mb-6 flex md:hidden' />
